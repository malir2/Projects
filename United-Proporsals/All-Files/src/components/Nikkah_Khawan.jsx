    ...
    <div className="bg-gradient-to-tl from-pink-200 via-gray-300 to-yellow-200">
      ...
      <section className="pt-[100px] pb-[50px]">
        ...
        <section className="w-[90%] mx-auto flex justify-between sm:justify-center translate-y-[30px] flex-wrap">
          <Link className="">
            <div className="bg-white/50 backdrop-blur-xl w-[300px] sm:w-[240px] h-[400px] sm:h-[300px] rounded-lg translate-y-[30PX] shadow-[2px_2px_10px_6px_rgba(204,198,201,0.8)] overflow-hidden hover:scale-105 transition-all duration-100">
              <img
