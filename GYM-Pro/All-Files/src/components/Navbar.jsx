...
function Navbar() {
  ...
  return (
    <nav className="flex text-white justify-between  mx-auto py-[40px] items-center">
      <div>
        <h1 className="text-4xl font-bold xsm:text-2xl">
          GYM<span className="text-red-600">-Pro</span>
        </h1>
      </div>
      <div className="flex items-center">
        <div>
          <ul className="flex w-[450px] justify-between items-center md:hidden">
            <li>
        ...
        <div>
          ...
          >
            <img src={menu} alt="" className="mr-7 hidden md:block" />
          </button>
        </div>
        <Link to="/cart" className="relative">
          <svg
            className="w-[40px] sm:w-[30px] fill-gray-600 hover:scale-110 transition-all ease-in-out"
          ...
          <div className="absolute inline-flex items-center justify-center w-6 h-6 sm:w-4 sm:h-4 sm:text-[10px] text-xs font-bold text-red-600 bg-gray-900 rounded-full -top-2 -right-2">
            0
          </div>
        </Link>
        <div>
          <ul
            className={`fixed top-[100px] ${
              right ? "right-0" : "right-[-100%]"
            }  w-[200px] h-[250px] flex flex-col justify-around rounded-lg bg-black/50 backdrop-blur-xl z-10 items-center transition-all ease-in-out duration-150`}
          >
            <li>
              <Link to="/">Home</Link>
            </li>
