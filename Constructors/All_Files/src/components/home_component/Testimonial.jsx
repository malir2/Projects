...
function Testimonial() {
  return (
    <div className="h-screen w-full bg-primary overflow-hidden md:h-auto md:p-[20px]">
      <h1 className="text-4xl mb-[20px] sm:mb-[5px] text-white text-center font-primary mt-[20px] md:text-3xl sm:text-xl">
        Testimonials
      </h1>
      <motion.section
        initial={{ y: "30vh", opacity: 0.3 }}
      ...
      >
        <div class="container px-5 py-24 mx-auto">
          <div class="w-[80%] mx-auto text-center">
            ...
            <p class="leading-relaxed text-lg sm:text-[8px]">
