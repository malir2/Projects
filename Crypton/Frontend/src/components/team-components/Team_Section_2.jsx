...
function Team_Section_2() {
  return (
    <div className="h-auto bg-white py-[50px]">
      ...
      <section className="grid grid-cols-3 grid-rows-1 md:grid-cols-1 md:grid-rows-3 w-[90%] gap-[50px] mx-auto mt-[80px] md:mt-[50px] overflow-hidden">
        <motion.div
          initial={{ y: "40vh", opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
          viewport={{ once: true }}
          transition={{ delay: 0.3, duration: 0.8 }}
          className="flex items-center flex-col justify-center gap-[10px] "
        >
          <div>
            <motion.div
              initial={{ borderColor: "#16d5ffFF" }}
          ...
          <div className=" md:text-center">
            ...
            <div className="flex gap-[20px] items-center mt-[20px] justify-center">
              <svg
                className="w-[15px] h-[15px]"
                viewBox="-5 0 20 20"
                version="1.1"
